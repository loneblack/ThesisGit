        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="col-sm-12">
                            <h2>Status: <span class="label label-success">Approved</span></h2>
                        ...
                        <br>
                            ...
                            <button type="button" class="btn btn-success" action="requestor_service_request_form_conforme.php" id="buttonConforme">Proceed to Conforme</button>
                    </div>
                </div>
                <!-- page end-->
            </section>
