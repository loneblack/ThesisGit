...
$queryReqInfo="SELECT * FROM thesis.requestor_receiving rr join request_borrow rb on rr.borrowID=rb.borrowID 
											where rr.id='{$id}'";
                                            ...
                                            <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo $_SERVER['PHP_SELF']."?id=".$id; ?>">
                                                ...
                                                <section>
													...
													<div class="form-group ">
                                                        ...
                                                        <h4 class="control-label col-lg-1"><?php echo $startDate;?></h4>
                                                    </div>
                                                    <div class="form-group">
