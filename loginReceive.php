...
<head>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="loginReceive_DB.php"> <!-- added action link and method-->
        <h2 class="form-signin-heading">sign in to receive assets</h2>
    ...
    <!-- ginalaw ko-->
      ...
      <button onclick="location.href='login.php'" class="btn btn-lg btn-block">Back</button>
