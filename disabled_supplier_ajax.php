<?php 
	...
	$query2="SELECT s.name FROM thesis.supplier s join canvasitemdetails cid on s.supplierID=cid.supplier_supplierID where cid.cavasItemID='{$canvasItemID}' and cid.status='5'";
