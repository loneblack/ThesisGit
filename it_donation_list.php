	...
	if(isset($_POST['confirm'])){
		if(!empty($_POST['markForDon'])){
			...
			foreach($markForDon as $forDon){
				$queryForDon="UPDATE `thesis`.`asset` SET `assetStatus`='1' WHERE `assetID`='{$forDon}'";
                                ...
                                <div class="col-sm-12">
                                    <section class="panel">
                                                    ...
                                                    <tbody>
														<?php
															...
															$queryAsset="SELECT a.assetID,rac.name as `assetCat`,rb.name as `brandName`,am.description as `assetModel`,ras.description as `assetStat`,a.propertyCode FROM thesis.asset a join assetmodel am on a.assetModel=am.assetModelID
																		  ...
																		  join ref_assetcategory rac on am.assetCategory=rac.assetCategoryID where a.assetStatus='16'";
                                        ...
                                        <div style="padding-left:10px; padding-bottom:10px">
                                            <button type="submit" name="confirm" onclick="Confirm()" class="btn btn-danger">Remove</button>
